...
<body>
	<div class="container">
		...
		<table style="width: 100%;  border-collapse: collapse;">
              ...
              <th style="width:50%;background-color:lightgray ; border:0.5px solid black;" colspan="2"> AREA PENGEMBANGAN</th>
            </tr>
            <?
            $totalArr=$jumlahPotensiStrength;
            if($jumlahPotensiStrength<$jumlahNilaiAkhirSaranPengembangan){
            	$totalArr=$jumlahNilaiAkhirSaranPengembangan;
            }
            for($index_catatan=0; $index_catatan<$totalArr; $index_catatan++)
            {
              $reqinfocatatan1= $arrPotensiStrength[$index_catatan]["KETERANGAN"];
              $reqinfocatatan2= $arrNilaiAkhirSaranPengembangan[$index_catatan]["KETERANGAN"];
            	?>
              	<tr>
