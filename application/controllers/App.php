...
class App extends CI_Controller {
	...
	function __construct() {
		parent::__construct();
		if($pg = $this->uri->segment(4)!='cetakan_feedback_lisan_isi' && $pg = $this->uri->segment(4)!='cetakan_feedback_tertulis_isi'){
			//kauth
	...
	public function index_popup()
	{
		...
		$this->load->view('admin/index_popup', $data);
	}
