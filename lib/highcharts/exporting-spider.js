...
(function(c) {
    ...
    p(c, "modules/exporting.src.js", [c["parts/Chart.js"], c["mixins/navigation.js"], c["parts/Globals.js"], c["parts/Options.js"],
        c["parts/SVGRenderer.js"], c["parts/Utilities.js"]
            ...
            addButton: function(a) {
                ...
                if (!1 !== d.enabled) {
                    ...
                    c ? A = function(a) {
                        ...
                        a && a.stopPropagation();
                        b.contextMenu(r.menuClassName, e, r.translateX,
                            r.translateY, r.width, r.height, r);
                        r.setState(2)
                    });
                    ...
                    if (d.symbol) {
                        var m = f.symbol(d.symbol, d.symbolX - h / 2, d.symbolY - h / 2,
                            h, h, {
                                width: h,
                                height: h
        ...
        c.prototype.inlineStyles = function() {
            ...
            function b(c) {
                function f(b, f) {
                    ...
                    for (q = e.length; q-- && !v;) v = e[q].test(f) ||
                        "function" === typeof b;
